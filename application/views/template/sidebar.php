    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="pcoded-hasmenu ">
                ...
                <ul class="pcoded-submenu">
                    <li class="">
                        <a href="<?=site_url('admin/laporan/pendapatan')?>" class="waves-effect waves-dark">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                    ...
                    <li class="">
                        <a href="<?=site_url('admin/laporan/pengeluaran')?>" class="waves-effect waves-dark">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                    ...
                    <li class="">
                        <a href="<?=site_url('admin/laporan/pemesanan')?>" class="waves-effect waves-dark">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
